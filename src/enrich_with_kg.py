...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--input-file", "--input", dest="input_file", type=str, required=True, help="Prediction CSV/JSONL/XLSX.")
    parser.add_argument("--kg-graph", "--kg", dest="kg_graph", type=str, required=True, help="KG or standard library JSON path.")
    parser.add_argument("--output-file", "--output", dest="output_file", type=str, required=True, help="Output issue-level CSV/JSONL/XLSX.")
    parser.add_argument(
        "--standard-report",
        type=str,
        default="outputs/kg_standard_priority_legacy.csv",
        help="Output standard priority CSV/JSONL/XLSX.",
    )
    parser.add_argument(
        "--markdown-report",
        type=str,
        default="outputs/kg_revision_report.md",
